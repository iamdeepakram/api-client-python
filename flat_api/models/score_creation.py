...
class ScoreCreation(object):
    ...
    def __init__(self, title=None, filename=None, privacy=None, data=None, data_encoding=None, source=None, collection=None, google_drive_folder=None, local_vars_configuration=None):  # noqa: E501
