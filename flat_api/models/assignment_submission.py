...
class AssignmentSubmission(object):
    ...
    def __init__(self, id=None, state=None, classroom=None, assignment=None, creator=None, creation_date=None, attachments=None, submission_date=None, student_comment=None, return_date=None, return_feedback=None, return_creator=None, google_classroom=None, local_vars_configuration=None):  # noqa: E501
    ...
    def state(self, state):
        ...
        :type: str
        """
        allowed_values = ["created", "turnedIn", "returned"]  # noqa: E501
