...
class Assignment(object):
    ...
    def __init__(self, state=None, title=None, classroom=None, description=None, attachments=None, submissions=None, creator=None, creation_date=None, scheduled_date=None, due_date=None, google_classroom=None, local_vars_configuration=None):  # noqa: E501
