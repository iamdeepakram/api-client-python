...
class ResourceCollaborator(object):
    ...
    def __init__(self, acl_read=False, acl_write=False, acl_admin=False, is_collaborator=False, id=None, score=None, collection=None, user=None, group=None, user_email=None, local_vars_configuration=None):  # noqa: E501
