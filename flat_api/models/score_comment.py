...
class ScoreComment(object):
    ...
    def __init__(self, id=None, type=None, user=None, score=None, revision=None, reply_to=None, date=None, modification_date=None, comment=None, raw_comment=None, context=None, mentions=None, resolved=None, resolved_by=None, spam=None, local_vars_configuration=None):  # noqa: E501
